...
## COIN Client Onboarding

COIN (Client Onboard Information Form) is a secure owner-facing intake link generated by a farrier. Owners can submit their contact, property, access, and horse information without a FarrierOS membership. The submission enters the sending farrier's workspace for review before it creates or updates records. COIN requires the hosted accounts and cloud-records layer and is targeted for the private beta.
